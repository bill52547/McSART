#include "host_McSART.h" // consists all required package and functions
void host_McSART_single_view
(float *d_img, float *d_img1, float *d_proj, int *int_para, float *float_para, 
    float *d_alpha_x, float *d_alpha_y, float *d_alpha_z, 
    float *d_beta_x, float *d_beta_y, float *d_beta_z, 
    float *d_const_x, float *d_const_y, float *d_const_z,
    float *volume, float *flow, float *ref_volumes, float *ref_flows
)
{
