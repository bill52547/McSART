...
__host__ void host_deform2(float *d_img1, float *d_img, int nx, int ny, int nz, float volume_diff, float flow_diff, float *alpha_x, float *alpha_y, float *alpha_z, float *beta_x, float *beta_y, float *beta_z);
